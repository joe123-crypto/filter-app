  ...
  return (
    <div className="max-w-md mx-auto animate-fade-in">
      ...
      <div className="bg-base-200 p-8 rounded-lg shadow-xl">
        <h2 className="text-3xl font-bold text-white text-center mb-6">Join or Sign In</h2>
        <form onSubmit={(e) => e.preventDefault()} className="space-y-6">
          <div>
            <label htmlFor="email" className="block text-sm font-medium text-content-100 mb-1">
              Email Address
            </label>
            <input
              type="email"
          ...
          <div>
            <label
              htmlFor="password"
              className="block text-sm font-medium text-content-100 mb-1"
            >
              Password
            </label>
            <input
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button
              ...
              disabled={isLoading}
              className="flex-1 flex justify-center items-center bg-brand-primary hover:bg-brand-secondary text-white font-bold py-3 px-4 rounded-lg transition-colors disabled:opacity-50"
            >
            ...
            <button
              ...
              disabled={isLoading}
              className="flex-1 flex justify-center items-center bg-base-300 hover:bg-gray-600 text-white font-bold py-3 px-4 rounded-lg transition-colors disabled:opacity-50"
            >
